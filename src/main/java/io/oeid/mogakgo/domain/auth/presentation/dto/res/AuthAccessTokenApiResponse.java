...
@Getter
public class AuthAccessTokenApiResponse {
    ...
    private AuthAccessTokenApiResponse(String accessToken, Boolean signUpComplete) {
        this.accessToken = accessToken;
        this.signUpComplete = signUpComplete;
    }

    public static AuthAccessTokenApiResponse of(String accessToken, Boolean signUpComplete) {
        return new AuthAccessTokenApiResponse(accessToken, signUpComplete);
    }
}
