...
import io.oeid.mogakgo.domain.user.presentation.dto.res.UserProfileApiResponse;
...
public class UserController {
    ...
    @GetMapping("/{userId}")
    public ResponseEntity<UserProfileApiResponse> userProfileApi(@PathVariable Long userId) {
        var response = userService.getUserProfile(userId);
        return ResponseEntity.ok(UserProfileApiResponse.from(response));
    }
